...
class gpsLocalization(object):
	def __init__(self):
		rospy.init_node('h1_gpsLocalization') #start the control node

		rospy.Subscriber('/husky1/odometry/filtered', Odometry, self.updatePosition)
		rospy.Subscriber('/husky1/imu/data', Imu, self.updateRotation)
