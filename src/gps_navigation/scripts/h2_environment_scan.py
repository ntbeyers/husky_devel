...
path.append('/modules/')
from h2_gpsLocalization import gpsLocalization
from sensor_msgs.msg import LaserScan
from h2_actuate import ROS2DimActuate
...
class Navigation(object):
    ...
    def __init__(self):
        ...
        sleep(2)
        self.subscriber = rospy.Subscriber('/husky2/scan', LaserScan, self.move, queue_size=1) #Call move for each laser scan
