...
class gpsLocalization(object):
	def __init__(self):
		rospy.init_node('h2_gpsLocalization') #start the control node

		rospy.Subscriber('/husky2/odometry/filtered', Odometry, self.updatePosition)
		rospy.Subscriber('/husky2/imu/data', Imu, self.updateRotation)
